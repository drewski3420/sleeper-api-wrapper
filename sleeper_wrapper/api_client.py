...
class SleeperApiClient:
  ...
  def get_user(self, user_input: str | int) -> dict:
    return self.get_by_path(f"user/{user_input}")

  def get_user_leagues(self, user_id: str | int, sport: str, season: str | int) -> list:
    return self.get_by_path(f"user/{user_id}/leagues/{sport}/{season}")

  def get_user_drafts(self, user_id: str | int, sport: str, season: str | int) -> list:
    return self.get_by_path(f"user/{user_id}/drafts/{sport}/{season}")

  def get_league(self, league_id: str | int) -> dict:
    return self.get_by_path(f"league/{league_id}")

  def get_league_users(self, league_id: str | int) -> list:
    return self.get_by_path(f"league/{league_id}/users")

  def get_league_rosters(self, league_id: str | int) -> list:
    return self.get_by_path(f"league/{league_id}/rosters")

  def get_league_drafts(self, league_id: str | int) -> list:
    return self.get_by_path(f"league/{league_id}/drafts")

  def get_league_matchups(self, league_id: str | int, week: str | int) -> list:
    return self.get_by_path(f"league/{league_id}/matchups/{week}")

  def get_league_transactions(self, league_id: str | int, week: str | int) -> list:
    return self.get_by_path(f"league/{league_id}/transactions/{week}")

  def get_draft(self, draft_id: str | int) -> dict:
    return self.get_by_path(f"draft/{draft_id}")

  def get_draft_picks(self, draft_id: str | int) -> list:
    return self.get_by_path(f"draft/{draft_id}/picks")

  def get_draft_traded_picks(self, draft_id: str | int) -> list:
  ...
  def get_stats(self, sport: str, season_type: str, season: str | int) -> dict:
    return self.get_by_path(f"stats/{sport}/{season_type}/{season}")

  def get_week_stats(self, sport: str, season_type: str, season: str | int, week: str | int) -> dict:
    return self.get_by_path(f"stats/{sport}/{season_type}/{season}/{week}")

  def get_projections(self, sport: str, season_type: str, season: str | int) -> dict:
    return self.get_by_path(f"projections/{sport}/{season_type}/{season}")

  def get_week_projections(self, sport: str, season_type: str, season: str | int, week: str | int) -> dict:
